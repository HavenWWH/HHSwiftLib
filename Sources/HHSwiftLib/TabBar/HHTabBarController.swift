...
open class HHTabBarController: UITabBarController {
    //滑动手势
    ...
    public override var selectedViewController: UIViewController? {
        willSet {
            ...
            guard let tabBar = tabBar as? HHTabBar, let index = viewControllers?.firstIndex(of: newValue) else {
                return
            }
    ...
    public override var selectedIndex: Int {
        willSet {
            guard let tabBar = tabBar as? HHTabBar else {
                return
            }
    ...
    open override func viewDidLoad() {
        super.viewDidLoad()
        setValue(hhTabBar, forKey: "tabBar")
...
//        view.addGestureRecognizer(panGesture)
    ...
    public func setTabbarBackColor(_ color: UIColor = .white){
        hhTabBar.imageView.backgroundColor = color
    }
    ///设置tabbar背景图片
    public func setTabbarBackImage(_ image: UIImage?){
        hhTabBar.imageView.image = image
    }

}

extension HHTabBarController {
