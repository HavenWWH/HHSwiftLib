...
public class HHSandBox {
    ...
    public class func filesWithoutFolder(at folderPath:String) -> Array<String>? {
        return filesWithoutFolder(at: folderPath, extensions: nil)
    }
    ...
    ///   - data: shuju
    /// - Returns: 文件路径
    public class func createDocumentFile(fileName:String, data:Data? = nil) -> String? {
        return createDocumentFile(folderName: nil, fileName: fileName, data: data)
    }
    ...
    ///   - data: 数据
    /// - Returns: 文件路径
    public class func createDocumentFile(folderName:String?, fileName:String, data:Data? = nil) ->String? {
        let documentDictory = documentPath()
        var currentFolderPath = documentDictory
        if let folderName = folderName {
            currentFolderPath = "\(documentDictory)/\(folderName)"
        }
    ...
    ///   - data: 数据
    /// - Returns: 文件路径
    public class func createCacheFile(with fileName:String, data:Data? = nil) -> String? {
    ...
    ///   - data: 数据
    /// - Returns: 文件路径
    public class func createCacheFile(folderName:String?, fileName:String, data:Data? = nil) -> String? {
        let cacheDictory = cachePath()
        var currentFolderPath = cacheDictory
        if let folderName = folderName {
            currentFolderPath = "\(cacheDictory)/\(folderName)"
        }
        return createFile(folderPath: currentFolderPath, fileName: fileName, data: data)
    }
    ...
    ///   - data: 数据
    /// - Returns: 文件路径
    public class func createFile(folderPath:String, fileName:String, data:Data? = nil) -> String? {
        ...
        let filePath = "\(folderPath)/\(fileName)"
        guard let data = data else {return filePath}
        do {
            let url = URL.init(fileURLWithPath: filePath)
