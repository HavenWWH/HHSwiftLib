...
public class HHWatermarkView: UIView {
   ...
   // 水印颜色
   public var txtColor: UIColor = UIColor.black.withAlphaComponent(0.1)
    ...
    public override func draw(_ rect: CGRect) {
     ...
     // 保存上下文状态
       ...
       context?.translateBy(x: -rect.width / 2, y: -rect.height / 2)
         ...
         // 构造水印内容
       let date = Date()
       let textAttribute:[NSAttributedString.Key : Any] =  [.foregroundColor:txtColor,
